...
--
-- Hôte : localhost:3306
-- Généré le : jeu. 01 avr. 2021 à 13:36
...
--
-- Structure de la table `assoc_as`
--

CREATE TABLE `assoc_as` (
  `assoc_as_id` int(11) NOT NULL,
  `assoc_a_id` int(11) NOT NULL,
  `assoc_s_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;

--
-- Déchargement des données de la table `assoc_as`
--

INSERT INTO `assoc_as` (`assoc_as_id`, `assoc_a_id`, `assoc_s_id`) VALUES
(3, 6, 46);
...
--
-- Index pour la table `assoc_as`
--
ALTER TABLE `assoc_as`
  ADD PRIMARY KEY (`assoc_as_id`),
...
--
-- AUTO_INCREMENT pour la table `assoc_as`
--
ALTER TABLE `assoc_as`
  MODIFY `assoc_as_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `styles`
  MODIFY `style_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=587;
...
--
-- Contraintes pour la table `assoc_as`
--
ALTER TABLE `assoc_as`
  ADD CONSTRAINT `assoc_as_ibfk_1` FOREIGN KEY (`assoc_s_id`) REFERENCES `styles` (`style_id`),
  ADD CONSTRAINT `assoc_as_ibfk_2` FOREIGN KEY (`assoc_a_id`) REFERENCES `artists` (`artist_id`);
